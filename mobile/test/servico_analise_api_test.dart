...
void main() {
  test('envia token, opÃ§Ãµes e chave de idempotÃªncia para a API', () async {
          ...
          'resolucao': [
            {
              ...
              'EquaÃ§Ã£o final': 'A+ = S.x0',
            },
          ],
          'versao_motor': 'teste',
          'validacoes': ['SequÃªncia validada.'],
          'observacoes': <String>[],
          'mapa_svg': '<svg></svg>',
          'mapa_largura': 1200,
          'mapa_altura': 700,
    ...
    expect(corpo.containsKey('chave_idempotencia'), isFalse);
      ...
      (_) async => http.Response(
        jsonEncode({
          'erro': {
            ...
            'mensagem': 'VocÃª nÃ£o possui anÃ¡lises disponÃ­veis.',
          },
        }),
        403,
      ),
      ...
      throwsA(
        isA<FalhaAnalise>()
            ...
            .having(
              (erro) => erro.mensagem,
              'mensagem',
              'VocÃª nÃ£o possui anÃ¡lises disponÃ­veis.',
            ),
      ),
    );
  });
